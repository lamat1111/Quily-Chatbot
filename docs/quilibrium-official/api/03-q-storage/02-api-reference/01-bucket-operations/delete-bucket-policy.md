...
The `DeleteBucketPolicy` operation deletes the policy on the specified bucket. To delete a policy, you must be the bucket owner or have the `s3:DeleteBucketPolicy` permission.
...
You must have the `s3:DeleteBucketPolicy` permission.

## Try It Out

<ApiTester
  operation="DeleteBucketPolicy"
  description="Delete the policy from a bucket."
  parameters={[
    {
      name: "bucketName",
      type: "text",
      ...
      description: "Name of the bucket to delete policy from"
    },
    ...HEADER_PARAMETERS
  ]}
  exampleResponse={{
