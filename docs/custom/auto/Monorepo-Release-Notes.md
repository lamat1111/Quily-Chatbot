...
- implemented automatic shard leaving for overcrowded shards
...
- forced registry refresh for waiting workers and added wait logging
...
- improved respawn logic and added isolation logging
